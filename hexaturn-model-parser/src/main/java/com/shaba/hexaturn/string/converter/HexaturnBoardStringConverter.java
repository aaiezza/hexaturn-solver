...
import com.shaba.hexaturn.HexSatelliteData.HexSatelliteDataBuilder;
...
public class HexaturnBoardStringConverter implements BoardStringConverter
{
    ...
    public static class StringHex
    {
        ...
        private final HexSatelliteData data;
        ...
        public static Stream<StringHex> parse( final String hexInfo )
        {
            ...
            final HexSatelliteDataBuilder dataBuilder = HexSatelliteData.builder();
            ...
            while ( contents.hasNext() )
            {
                ...
                {
                case 'b':
                    dataBuilder.wasNeverBlockable( !hasAttribute );
                    break;
                case 'l':
                ...
                default:
                    OccupantCode.parseCode( c )
                        ...
                        .ifPresent( dataBuilder::addOccupant );
                }
            }
     ...
     */
    @Override
    public Map<Integer, HexSatelliteData> convertBoardCode(
            final String boardCode )
    {
        return convertBoardCodeStream( boardCode ).toImmutableMap();
    }

    public EntryStream<Integer, HexSatelliteData> convertBoardCodeStream(
            final String boardCode )
    {
